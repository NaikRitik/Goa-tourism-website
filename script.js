...
// Booking system
document.querySelector('.tours .ctn').addEventListener('click', function () {
    const bookingSection = document.getElementById("booking");
    bookingSection.style.display = 'block';  // Show the booking section
});

document.querySelector('.tours .ctn').addEventListener('click', function (event) {
...
// Explore Button
document.querySelector('.explore-content .ctn').addEventListener('click', function (event) {
    event.preventDefault(); // Prevents jumping to the top
